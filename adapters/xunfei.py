    ...
    async def chat(self, messages: List[Dict[str, str]]) -> Dict[str, Any]:
        ...
        try:
            ...
            async with session.post(
                "https://spark-api.xf-yun.com/v3/chat/completions",
                json=data,
                ...
                if response.status == 200:
                    ...
                    return self.build_response("讯飞星火服务暂时不可用，请稍后重试", self.model)
        ...
        try:
            ...
            async with session.post(
                ...
                if response.status == 200:
                    ...
                    yield self.build_stream_chunk("讯飞星火服务暂时不可用，请稍后重试", self.model)
                    yield self.build_stream_chunk("", self.model, finish=True)
        except Exception as e:
